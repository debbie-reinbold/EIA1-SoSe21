...
window.addEventListener("load", function (): void {
  ...
  let toDoArray: ToDo[] = [
    {
      todosText: "Boden wischen",
      todosChecked: true
    },
    {
      todosText: "Hausarbeit schreiben",
      todosChecked: false
    },
    {
      todosText: "lesen",
  ...
  function updateCounter(): void {
    ...
    // closed tasks
    const closedTasks: ToDo[] = toDoArray.filter((todo) => {
    ...
    // open tasks
    const openTasks: ToDo[] = toDoArray.filter((todo) => {
